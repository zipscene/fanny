...
public:
    ...
    void Execute()
    {
        ...
        if (!ann)
            return SetErrorMessage("Error loading FANN file");
...
{
public:
    SaveFileWorker(Nan::Callback *callback, v8::Local<v8::Object> fannyHolder, std::string _filename, bool _isFixed) : Nan::AsyncWorker(callback), filename(_filename), isFixed(_isFixed)
    {
        SaveToPersistent("fannyHolder", fannyHolder);
        fanny = Nan::ObjectWrap::Unwrap<FANNY>(fannyHolder);
    }
...
public:
    ...
    TrainWorker(
        ...
        float _desiredError,
        bool _singleEpoch,
        bool _isTest) : Nan::AsyncProgressWorker(callback), trainFromFile(_trainFromFile), filename(_filename),
...
NAN_METHOD(FANNY::randomizeWeights)
{
    FANNY *fanny = Nan::ObjectWrap::Unwrap<FANNY>(info.Holder());
    if (info.Length() != 2)
        return Nan::ThrowError("Must have 2 arguments: min_weight and max_weight");
...
{
    if (info.Length() != 2)
        return Nan::ThrowError("Requires filename and callback");
...
{
    if (info.Length() != 2)
        return Nan::ThrowError("Takes a filename and a callback");
    if (!info[0]->IsString() || !info[1]->IsFunction())
        return Nan::ThrowTypeError("Wrong argument type");
    std::string filename(*Nan::Utf8String(info[0]->ToString(Nan::GetCurrentContext()).FromMaybe(v8::Local<v8::String>())));
    Nan::Callback *callback = new Nan::Callback(info[1].As<v8::Function>());
    ...
    bool isTest)
{
    ...
    {
        if (!info[0]->IsObject())
            return Nan::ThrowTypeError("First argument must be TrainingData");
    ...
    if (!info[numArgs - 1]->IsFunction())
        return Nan::ThrowTypeError("Last argument must be callback");
...
NAN_METHOD(FANNY::run)
{
    FANNY *fanny = Nan::ObjectWrap::Unwrap<FANNY>(info.Holder());
    if (info.Length() != 1)
        return Nan::ThrowError("Takes one argument");
    if (!info[0]->IsArray())
        return Nan::ThrowError("Must be array");
    std::vector<fann_type> inputs = v8ArrayToFannData(info[0]);
    if (inputs.size() != fanny->fann->get_num_input())
        return Nan::ThrowError("Wrong number of inputs");
...
NAN_METHOD(FANNY::runAsync)
{
    FANNY *fanny = Nan::ObjectWrap::Unwrap<FANNY>(info.Holder());
    if (info.Length() != 2)
        return Nan::ThrowError("Takes two arguments");
    if (!info[0]->IsArray())
        return Nan::ThrowError("First argument must be array");
    if (!info[1]->IsFunction())
        return Nan::ThrowError("Second argument must be callback");
    std::vector<fann_type> inputs = v8ArrayToFannData(info[0]);
    if (inputs.size() != fanny->fann->get_num_input())
        return Nan::ThrowError("Wrong number of inputs");
    Nan::Callback *callback = new Nan::Callback(info[1].As<v8::Function>());
...
NAN_METHOD(FANNY::setTrainingAlgorithm)
{
    FANNY *fanny = Nan::ObjectWrap::Unwrap<FANNY>(info.Holder());
    if (info.Length() != 1)
        return Nan::ThrowError("Must have an arguments: training_algorithm");
    if (!info[0]->IsString())
        return Nan::ThrowError("training_algorithm not a string");

    FANN::training_algorithm_enum value;
    if (v8StringToTrainingAlgorithmEnum(info[0], value))
        fanny->fann->set_training_algorithm(value);
}
...
NAN_METHOD(FANNY::setTrainErrorFunction)
{
    FANNY *fanny = Nan::ObjectWrap::Unwrap<FANNY>(info.Holder());
    if (info.Length() != 1)
        return Nan::ThrowError("Must have an arguments: train_error_function");
    if (!info[0]->IsString())
        return Nan::ThrowError("train_error_function not a string");

    FANN::error_function_enum value;
    if (v8StringToErrorFunctionEnum(info[0], value))
        fanny->fann->set_train_error_function(value);
}
...
NAN_METHOD(FANNY::setTrainStopFunction)
{
    FANNY *fanny = Nan::ObjectWrap::Unwrap<FANNY>(info.Holder());
    if (info.Length() != 1)
        return Nan::ThrowError("Must have an arguments: train_stop_function");
    if (!info[0]->IsString())
        return Nan::ThrowError("train_stop_function not a string");

    FANN::stop_function_enum value;
    if (v8StringToStopFunctionEnum(info[0], value))
        fanny->fann->set_train_stop_function(value);
}
...
NAN_METHOD(FANNY::setBitFailLimit)
{
    FANNY *fanny = Nan::ObjectWrap::Unwrap<FANNY>(info.Holder());
    if (info.Length() != 1)
        return Nan::ThrowError("Must have an arguments: bit_fail_limit");
    if (!info[0]->IsNumber())
        return Nan::ThrowError("bit_fail_limit not a number");
...
NAN_METHOD(FANNY::setLearningRate)
{
    ...
    if (info.Length() != 1)
        return Nan::ThrowError("Must have an arguments: learning_rate");
    if (!info[0]->IsNumber())
        return Nan::ThrowError("learning_rate not a number");
...
{
    if (info.Length() != 2)
        return Nan::ThrowError("Must have 2 arguments: layer and neuron");
    if (!info[0]->IsNumber())
        return Nan::ThrowError("layer must be a number");
    if (!info[1]->IsNumber())
        return Nan::ThrowError("neuron must be a number");
...
{
    if (info.Length() != 3)
        return Nan::ThrowError("Must have 3 arguments: activation_function, layer, and neuron");
    if (!info[0]->IsString())
        return Nan::ThrowError("activation_function must be a string");
    if (!info[1]->IsNumber())
        return Nan::ThrowError("layer must be a number");
    if (!info[2]->IsNumber())
        return Nan::ThrowError("neuron must be a number");
    ...
    if (v8StringToActivationFunctionEnum(info[0], activationFunction))
        fanny->fann->set_activation_function(activationFunction, layer, neuron);
}

NAN_METHOD(FANNY::setActivationFunctionLayer)
{
    if (info.Length() != 2)
        return Nan::ThrowError("Must have 2 arguments: activation_function, layer");
    if (!info[0]->IsString())
        return Nan::ThrowError("activation_function must be a string");
    if (!info[1]->IsNumber())
        return Nan::ThrowError("layer must be a number");
    ...
    FANN::activation_function_enum activationFunction;
    if (v8StringToActivationFunctionEnum(info[0], activationFunction))
        fanny->fann->set_activation_function_layer(activationFunction, layer);
}

NAN_METHOD(FANNY::setActivationFunctionHidden)
{
    if (info.Length() != 1)
        return Nan::ThrowError("Must have an arguments: activation_function,");
    if (!info[0]->IsString())
        return Nan::ThrowError("activation_function must be a string");
    ...
    FANN::activation_function_enum activationFunction;
    if (v8StringToActivationFunctionEnum(info[0], activationFunction))
        fanny->fann->set_activation_function_hidden(activationFunction);
}
...
NAN_METHOD(FANNY::setActivationFunctionOutput)
{
    ...
    FANN::activation_function_enum activationFunction;
    if (v8StringToActivationFunctionEnum(info[0], activationFunction))
        fanny->fann->set_activation_function_output(activationFunction);
}
...
NAN_METHOD(FANNY::setQuickpropDecay)
{
    FANNY *fanny = Nan::ObjectWrap::Unwrap<FANNY>(info.Holder());
    if (info.Length() != 1)
        return Nan::ThrowError("Must have an arguments: quickprop_decay");
    if (!info[0]->IsNumber())
        return Nan::ThrowError("quickprop_decay not a number");
...
NAN_METHOD(FANNY::setQuickpropMu)
{
    FANNY *fanny = Nan::ObjectWrap::Unwrap<FANNY>(info.Holder());
    if (info.Length() != 1)
        return Nan::ThrowError("Must have an arguments: quickprop_mu");
    if (!info[0]->IsNumber())
        return Nan::ThrowError("quickprop_mu not a number");
...
NAN_METHOD(FANNY::setRpropIncreaseFactor)
{
    FANNY *fanny = Nan::ObjectWrap::Unwrap<FANNY>(info.Holder());
    if (info.Length() != 1)
        return Nan::ThrowError("Must have an arguments: rprop_increase_factor");
    if (!info[0]->IsNumber())
        return Nan::ThrowError("rprop_increase_factor not a number");
...
NAN_METHOD(FANNY::setRpropDecreaseFactor)
{
    FANNY *fanny = Nan::ObjectWrap::Unwrap<FANNY>(info.Holder());
    if (info.Length() != 1)
        return Nan::ThrowError("Must have an arguments: rprop_decrease_factor");
    if (!info[0]->IsNumber())
        return Nan::ThrowError("rprop_decrease_factor not a number");
...
NAN_METHOD(FANNY::setRpropDeltaZero)
{
    FANNY *fanny = Nan::ObjectWrap::Unwrap<FANNY>(info.Holder());
    if (info.Length() != 1)
        return Nan::ThrowError("Must have an arguments: rprop_delta_zero");
    if (!info[0]->IsNumber())
        return Nan::ThrowError("rprop_delta_zero not a number");
...
NAN_METHOD(FANNY::setRpropDeltaMin)
{
    FANNY *fanny = Nan::ObjectWrap::Unwrap<FANNY>(info.Holder());
    if (info.Length() != 1)
        return Nan::ThrowError("Must have an arguments: rprop_delta_min");
    if (!info[0]->IsNumber())
        return Nan::ThrowError("rprop_delta_min not a number");
...
NAN_METHOD(FANNY::setRpropDeltaMax)
{
    FANNY *fanny = Nan::ObjectWrap::Unwrap<FANNY>(info.Holder());
    if (info.Length() != 1)
        return Nan::ThrowError("Must have an arguments: rprop_delta_max");
    if (!info[0]->IsNumber())
        return Nan::ThrowError("rprop_delta_max not a number");
...
NAN_METHOD(FANNY::setSarpropWeightDecayShift)
{
    FANNY *fanny = Nan::ObjectWrap::Unwrap<FANNY>(info.Holder());
    if (info.Length() != 1)
        return Nan::ThrowError("Must have an arguments: sarprop_weight_decay_shift");
    if (!info[0]->IsNumber())
        return Nan::ThrowError("sarprop_weight_decay_shift not a number");
...
NAN_METHOD(FANNY::setSarpropStepErrorThresholdFactor)
{
    FANNY *fanny = Nan::ObjectWrap::Unwrap<FANNY>(info.Holder());
    if (info.Length() != 1)
        return Nan::ThrowError("Must have an arguments: sarprop_step_error_threshold_factor");
    if (!info[0]->IsNumber())
        return Nan::ThrowError("sarprop_step_error_threshold_factor not a number");
...
NAN_METHOD(FANNY::setSarpropStepErrorShift)
{
    FANNY *fanny = Nan::ObjectWrap::Unwrap<FANNY>(info.Holder());
    if (info.Length() != 1)
        return Nan::ThrowError("Must have an arguments: sarprop_step_error_shift");
    if (!info[0]->IsNumber())
        return Nan::ThrowError("sarprop_step_error_shift not a number");
...
NAN_METHOD(FANNY::setSarpropTemperature)
{
    FANNY *fanny = Nan::ObjectWrap::Unwrap<FANNY>(info.Holder());
    if (info.Length() != 1)
        return Nan::ThrowError("Must have an arguments: sarprop_temperature");
    if (!info[0]->IsNumber())
        return Nan::ThrowError("sarprop_temperature not a number");
...
NAN_METHOD(FANNY::setLearningMomentum)
{
    FANNY *fanny = Nan::ObjectWrap::Unwrap<FANNY>(info.Holder());
    if (info.Length() != 1)
        return Nan::ThrowError("Must have an arguments: learning_momentum");
    if (!info[0]->IsNumber())
        return Nan::ThrowError("learning_momentum not a number");
...
{
    if (info.Length() != 1)
        return Nan::ThrowError("Takes an argument");
    if (!Nan::New(TrainingData::constructorFunctionTpl)->HasInstance(info[0]))
    {
...
NAN_METHOD(FANNY::train)
{
    ...
    FANNY *fanny = Nan::ObjectWrap::Unwrap<FANNY>(info.Holder());
    if (info.Length() != 2)
        return Nan::ThrowError("Must have 2 arguments: input, desired_output");
    if (!info[0]->IsArray() || !info[1]->IsArray())
        return Nan::ThrowError("Argument not an array");

    std::vector<fann_type> input = v8ArrayToFannData(info[0]);
    std::vector<fann_type> desired_output = v8ArrayToFannData(info[1]);

    if (input.size() != fanny->fann->get_num_input())
        return Nan::ThrowError("Wrong number of inputs");
    if (desired_output.size() != fanny->fann->get_num_output())
        return Nan::ThrowError("Wrong number of desired ouputs");
...
NAN_METHOD(FANNY::scaleTrain)
{
    ...
    FANNY *fanny = Nan::ObjectWrap::Unwrap<FANNY>(info.Holder());
    if (info.Length() != 1)
        return Nan::ThrowError("Must have an argument: tainingData");
    if (!Nan::New(TrainingData::constructorFunctionTpl)->HasInstance(info[0]))
    {
        return Nan::ThrowError("Argument must be an instance of TrainingData");
    }
...
NAN_METHOD(FANNY::setInputScalingParams)
{
    ...
    FANNY *fanny = Nan::ObjectWrap::Unwrap<FANNY>(info.Holder());
    if (info.Length() != 3)
        return Nan::ThrowError("Must have 3 arguments: tainingData, new_input_min, and new_input_max");
    if (!Nan::New(TrainingData::constructorFunctionTpl)->HasInstance(info[0]))
    {
        return Nan::ThrowError("Argument must be an instance of TrainingData");
    }
...
NAN_METHOD(FANNY::setOutputScalingParams)
{
    ...
    FANNY *fanny = Nan::ObjectWrap::Unwrap<FANNY>(info.Holder());
    if (info.Length() != 3)
        return Nan::ThrowError("Must have 3 arguments: tainingData new_output_min, and new_output_max");
    if (!Nan::New(TrainingData::constructorFunctionTpl)->HasInstance(info[0]))
    {
        return Nan::ThrowError("Argument must be an instance of TrainingData");
    }
...
NAN_METHOD(FANNY::setScalingParams)
{
    ...
    FANNY *fanny = Nan::ObjectWrap::Unwrap<FANNY>(info.Holder());
    if (info.Length() != 5)
        return Nan::ThrowError("Must have 5 arguments: tainingData, new_input_min, new_input_max, new_output_min, and new_output_max");
    if (!Nan::New(TrainingData::constructorFunctionTpl)->HasInstance(info[0]))
    {
        return Nan::ThrowError("Argument must be an instance of TrainingData");
    }
...
NAN_METHOD(FANNY::scaleInput)
{
    ...
    FANNY *fanny = Nan::ObjectWrap::Unwrap<FANNY>(info.Holder());
    if (info.Length() != 1)
        return Nan::ThrowError("Must have an arguments: input_vector");
    if (!info[0]->IsArray())
        return Nan::ThrowError("Argument not an array");
...
NAN_METHOD(FANNY::scaleOutput)
{
    ...
    FANNY *fanny = Nan::ObjectWrap::Unwrap<FANNY>(info.Holder());
    if (info.Length() != 1)
        return Nan::ThrowError("Must have an arguments: output_vector");
    if (!info[0]->IsArray())
        return Nan::ThrowError("Argument not an array");

    std::vector<fann_type> output = v8ArrayToFannData(info[0]);

    if (output.size() != fanny->fann->get_num_output())
        return Nan::ThrowError("Wrong number of outputs");
...
NAN_METHOD(FANNY::getCascadeActivationFunctions)
{
    ...
    for (uint32_t idx = 0; idx < size; ++idx)
    {
        ...
        case FANN::THRESHOLD:
            str = "THRESHOLD";
            break;
        case FANN::THRESHOLD_SYMMETRIC:
            str = "THRESHOLD_SYMMETRIC";
            break;
        case FANN::SIGMOID:
            str = "SIGMOID";
            break;
        case FANN::SIGMOID_STEPWISE:
            str = "SIGMOID_STEPWISE";
            break;
        case FANN::SIGMOID_SYMMETRIC:
            str = "SIGMOID_SYMMETRIC";
            break;
        case FANN::SIGMOID_SYMMETRIC_STEPWISE:
            str = "SIGMOID_SYMMETRIC_STEPWISE";
            break;
        case FANN::GAUSSIAN:
            str = "GAUSSIAN";
            break;
        case FANN::GAUSSIAN_SYMMETRIC:
            str = "GAUSSIAN_SYMMETRIC";
            break;
        case FANN::GAUSSIAN_STEPWISE:
            str = "GAUSSIAN_STEPWISE";
            break;
        case FANN::ELLIOT:
            str = "ELLIOT";
            break;
        case FANN::ELLIOT_SYMMETRIC:
            str = "ELLIOT_SYMMETRIC";
            break;
        case FANN::LINEAR_PIECE:
            str = "LINEAR_PIECE";
            break;
        case FANN::LINEAR_PIECE_SYMMETRIC:
            str = "LINEAR_PIECE_SYMMETRIC";
            break;
        case FANN::SIN_SYMMETRIC:
            str = "SIN_SYMMETRIC";
            break;
        case FANN::COS_SYMMETRIC:
            str = "COS_SYMMETRIC";
            break;
        case FANN::COS:
            str = "COS";
...
NAN_METHOD(FANNY::setCascadeActivationFunctions)
{
#ifndef FANNY_FIXED
    if (!info[0]->IsArray())
        return Nan::ThrowError("1st argument must be an array");
    if (!info[1]->IsNumber())
        return Nan::ThrowError("2nd argument must be a number");
    ...
    if (inputs->Length() != size)
        return Nan::ThrowError("The length of the array must be the second argument");
    FANNY *fanny = Nan::ObjectWrap::Unwrap<FANNY>(info.Holder());
        ...
        if (!maybeIdxValue.IsEmpty())
        {
            ...
            if (value->IsString())
            {
                ...
                if (str.compare("LINEAR") == 0)
                    ...
                    ret = FANN::THRESHOLD;
                else if (str.compare("THRESHOLD_SYMMETRIC") == 0)
                    ret = FANN::THRESHOLD_SYMMETRIC;
                else if (str.compare("SIGMOID") == 0)
                    ret = FANN::SIGMOID;
                else if (str.compare("SIGMOID_STEPWISE") == 0)
                    ret = FANN::SIGMOID_STEPWISE;
                else if (str.compare("SIGMOID_SYMMETRIC") == 0)
                    ret = FANN::SIGMOID_SYMMETRIC;
                else if (str.compare("SIGMOID_SYMMETRIC_STEPWISE") == 0)
                    ret = FANN::SIGMOID_SYMMETRIC_STEPWISE;
                else if (str.compare("GAUSSIAN") == 0)
                    ret = FANN::GAUSSIAN;
                else if (str.compare("GAUSSIAN_SYMMETRIC") == 0)
                    ret = FANN::GAUSSIAN_SYMMETRIC;
                else if (str.compare("GAUSSIAN_STEPWISE") == 0)
                    ret = FANN::GAUSSIAN_STEPWISE;
                else if (str.compare("ELLIOT") == 0)
                    ret = FANN::ELLIOT;
                else if (str.compare("ELLIOT_SYMMETRIC") == 0)
                    ret = FANN::ELLIOT_SYMMETRIC;
                else if (str.compare("LINEAR_PIECE") == 0)
                    ret = FANN::LINEAR_PIECE;
                else if (str.compare("LINEAR_PIECE_SYMMETRIC") == 0)
                    ret = FANN::LINEAR_PIECE_SYMMETRIC;
                else if (str.compare("SIN_SYMMETRIC") == 0)
                    ret = FANN::SIN_SYMMETRIC;
                else if (str.compare("COS_SYMMETRIC") == 0)
                    ret = FANN::COS_SYMMETRIC;
...
NAN_METHOD(FANNY::setCascadeActivationSteepnesses)
{
    ...
    FANNY *fanny = Nan::ObjectWrap::Unwrap<FANNY>(info.Holder());
    if (info.Length() != 2)
        return Nan::ThrowError("Must have 2 arguments: 	cascade_activation_steepnesses and cascade_activation_steepnesses_count");
    if (!info[0]->IsArray())
        return Nan::ThrowError("cascade_activation_steepnesse not an array");
    if (!info[1]->IsNumber())
        return Nan::ThrowError("cascade_activation_steepnesses_count not a number");
    ...
    if (cascadeActivationSteepnesses.size() != cascadeActivationSteepnessesCount)
        return Nan::ThrowError("Wrong number of steepnesses or count");
...
NAN_METHOD(FANNY::setCascadeOutputChangeFraction)
{
    ...
    FANNY *fanny = Nan::ObjectWrap::Unwrap<FANNY>(info.Holder());
    if (info.Length() != 1)
        return Nan::ThrowError("Must have an arguments: cascade_output_change_fraction");
    if (!info[0]->IsNumber())
        return Nan::ThrowError("cascade_output_change_fraction not a number");
...
NAN_METHOD(FANNY::setCascadeOutputStagnationEpochs)
{
    ...
    FANNY *fanny = Nan::ObjectWrap::Unwrap<FANNY>(info.Holder());
    if (info.Length() != 1)
        return Nan::ThrowError("Must have an arguments: cascade_output_stagnation_epochs");
    if (!info[0]->IsNumber())
        return Nan::ThrowError("cascade_output_stagnation_epochs not a number");
...
NAN_METHOD(FANNY::setCascadeCandidateChangeFraction)
{
    ...
    FANNY *fanny = Nan::ObjectWrap::Unwrap<FANNY>(info.Holder());
    if (info.Length() != 1)
        return Nan::ThrowError("Must have an arguments: cascade_candidate_change_fraction");
    if (!info[0]->IsNumber())
        return Nan::ThrowError("cascade_candidate_change_fraction not a number");
...
NAN_METHOD(FANNY::setCascadeCandidateStagnationEpochs)
{
    ...
    FANNY *fanny = Nan::ObjectWrap::Unwrap<FANNY>(info.Holder());
    if (info.Length() != 1)
        return Nan::ThrowError("Must have an arguments: cascade_candidate_stagnation_epochs");
    if (!info[0]->IsNumber())
        return Nan::ThrowError("cascade_candidate_stagnation_epochs not a number");
...
NAN_METHOD(FANNY::setCascadeWeightMultiplier)
{
    ...
    FANNY *fanny = Nan::ObjectWrap::Unwrap<FANNY>(info.Holder());
    if (info.Length() != 1)
        return Nan::ThrowError("Must have an arguments: cascade_weight_multiplier");
    if (!info[0]->IsNumber())
        return Nan::ThrowError("cascade_weight_multiplier not a number");
...
NAN_METHOD(FANNY::setCascadeCandidateLimit)
{
    ...
    FANNY *fanny = Nan::ObjectWrap::Unwrap<FANNY>(info.Holder());
    if (info.Length() != 1)
        return Nan::ThrowError("Must have an arguments: cascade_candidate_limit");
    if (!info[0]->IsNumber())
        return Nan::ThrowError("cascade_candidate_limit not a number");
...
NAN_METHOD(FANNY::setCascadeMaxOutEpochs)
{
    ...
    FANNY *fanny = Nan::ObjectWrap::Unwrap<FANNY>(info.Holder());
    if (info.Length() != 1)
        return Nan::ThrowError("Must have an arguments: cascade_max_out_epochs");
    if (!info[0]->IsNumber())
        return Nan::ThrowError("cascade_max_out_epochs not a number");
...
NAN_METHOD(FANNY::setCascadeMaxCandEpochs)
{
    ...
    FANNY *fanny = Nan::ObjectWrap::Unwrap<FANNY>(info.Holder());
    if (info.Length() != 1)
        return Nan::ThrowError("Must have an arguments: cascade_max_cand_epochs");
    if (!info[0]->IsNumber())
        return Nan::ThrowError("cascade_max_cand_epochs not a number");
...
NAN_METHOD(FANNY::setCascadeNumCandidateGroups)
{
    ...
    FANNY *fanny = Nan::ObjectWrap::Unwrap<FANNY>(info.Holder());
    if (info.Length() != 1)
        return Nan::ThrowError("Must have an arguments: cascade_num_candidate_groups");
    if (!info[0]->IsNumber())
        return Nan::ThrowError("cascade_num_candidate_groups not a number");
...
NAN_METHOD(FANNY::getActivationSteepness)
{
    FANNY *fanny = Nan::ObjectWrap::Unwrap<FANNY>(info.Holder());
    if (info.Length() != 2)
        return Nan::ThrowError("Must have an arguments: layer and neuron");
    if (!info[0]->IsNumber() || !info[1]->IsNumber())
        return Nan::ThrowError("layer and neuron should be numbers");
    unsigned int layer = info[0]->Uint32Value(Nan::GetCurrentContext()).FromJust();
    unsigned int neuron = info[1]->Uint32Value(Nan::GetCurrentContext()).FromJust();
...
NAN_METHOD(FANNY::setActivationSteepness)
{
    FANNY *fanny = Nan::ObjectWrap::Unwrap<FANNY>(info.Holder());
    if (info.Length() != 3)
        return Nan::ThrowError("Must have 3 arguments");
...
NAN_METHOD(FANNY::setActivationSteepnessLayer)
{
    FANNY *fanny = Nan::ObjectWrap::Unwrap<FANNY>(info.Holder());
    if (info.Length() != 2)
        return Nan::ThrowError("Must have 2 arguments");
    if (!info[0]->IsNumber() || !info[1]->IsNumber())
    {
        return Nan::ThrowError("All arguments must be numbers");
    }
...
NAN_METHOD(FANNY::setActivationSteepnessHidden)
{
    FANNY *fanny = Nan::ObjectWrap::Unwrap<FANNY>(info.Holder());
    if (info.Length() != 1)
        return Nan::ThrowError("Must have 1 arguments");
    if (!info[0]->IsNumber())
    {
...
NAN_METHOD(FANNY::setWeightArray)
{
    FANNY *fanny = Nan::ObjectWrap::Unwrap<FANNY>(info.Holder());
    if (info.Length() != 2)
        return Nan::ThrowError("Must have two arguments");
    if (!info[0]->IsArray())
        return Nan::ThrowError("Connections must be an array");
    if (!info[1]->IsNumber())
        return Nan::ThrowError("size must be a number");
...
NAN_METHOD(FANNY::setUserDataString)
{
    ...
    if (info.Length() != 1 || !info[0]->IsString())
        return Nan::ThrowError("Argument must be string");
