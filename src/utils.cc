...
v8::Local<v8::Value> trainingAlgorithmEnumToV8String(FANN::training_algorithm_enum value)
{
    ...
    switch (value)
    {
    case FANN::TRAIN_INCREMENTAL:
        str = "TRAIN_INCREMENTAL";
        break;
    case FANN::TRAIN_BATCH:
        str = "TRAIN_BATCH";
        break;
    case FANN::TRAIN_RPROP:
        str = "TRAIN_RPROP";
        break;
    case FANN::TRAIN_QUICKPROP:
        str = "TRAIN_QUICKPROP";
        break;
    case FANN::TRAIN_SARPROP:
        str = "FANN_TRAIN_SARPROP";
        break;
    }
...
bool v8StringToTrainingAlgorithmEnum(v8::Local<v8::Value> value, FANN::training_algorithm_enum &ret)
{
    ...
    if (str.compare("TRAIN_INCREMENTAL") == 0)
        ret = FANN::TRAIN_INCREMENTAL;
    else if (str.compare("TRAIN_BATCH") == 0)
        ret = FANN::TRAIN_BATCH;
    else if (str.compare("TRAIN_RPROP") == 0)
        ret = FANN::TRAIN_RPROP;
    else if (str.compare("TRAIN_QUICKPROP") == 0)
        ret = FANN::TRAIN_QUICKPROP;
    else if (str.compare("FANN_TRAIN_SARPROP") == 0)
        ret = FANN::TRAIN_SARPROP;
    else
        return false;
    return true;
}
...
v8::Local<v8::Value> errorFunctionEnumToV8String(FANN::error_function_enum value)
{
    ...
    switch (value)
    {
    case FANN::ERRORFUNC_LINEAR:
        str = "ERRORFUNC_LINEAR";
        break;
    case FANN::ERRORFUNC_TANH:
        str = "ERRORFUNC_TANH";
        break;
    }
    v8::Local<v8::Value> ret;
...
bool v8StringToErrorFunctionEnum(v8::Local<v8::Value> value, FANN::error_function_enum &ret)
{
    if (!value->IsString())
        return false;
    std::string str(*Nan::Utf8String(value));
    if (str.compare("ERRORFUNC_LINEAR") == 0)
        ret = FANN::ERRORFUNC_LINEAR;
    else if (str.compare("ERRORFUNC_TANH") == 0)
        ret = FANN::ERRORFUNC_TANH;
    else
        return false;
    return true;
}
...
v8::Local<v8::Value> stopFunctionEnumToV8String(FANN::stop_function_enum value)
{
    ...
    switch (value)
    {
    case FANN::STOPFUNC_MSE:
        str = "STOPFUNC_MSE";
        break;
    case FANN::STOPFUNC_BIT:
        str = "STOPFUNC_BIT";
        break;
    }
    v8::Local<v8::Value> ret;
...
bool v8StringToStopFunctionEnum(v8::Local<v8::Value> value, FANN::stop_function_enum &ret)
{
    if (!value->IsString())
        return false;
    std::string str(*Nan::Utf8String(value));
    if (str.compare("STOPFUNC_MSE") == 0)
        ret = FANN::STOPFUNC_MSE;
    else if (str.compare("STOPFUNC_BIT") == 0)
        ret = FANN::STOPFUNC_BIT;
    else
        return false;
    return true;
}
