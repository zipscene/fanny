...
- getActivationSteepness - to add in c
- setActivationSteepness - to add in c
- setActivationSteepnessLayer - to add in c
- setActivationSteepnessHidden - to add in c
- setActivationSteepnessOutput - to add in c
- getLayerArray * - done
- getBiasArray * - done
- setWeightArray - to add in c
- setWeight - to add in c
- scaleTrain (rename to scaleTrainingData) * - done
- descaleTrain (rename to descaleTrainingData) * - done
- setInputScalingParams * - done
- setOutputScalingParams * - done
- setScalingParams * - done
- clearScalingParams * - done
- scaleInput * - done
- scaleOutput * - done
- descaleInput * - done
- descaleOutput * - done
