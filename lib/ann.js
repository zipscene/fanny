...
var annOptionFunctions = {
	...
	cascadeActivationFunctions: {
		setValue: function(value) {
			...
			// need to check with ACTIVATION_FUNCTIONS
			for (var cascadeActivationFunction of value) {
				if (ACTIVATION_FUNCTIONS.find(function(name) { return name === cascadeActivationFunction })) {
...
ANN.prototype.getActivationFunction = wrapThrows(function(layer, neruon) {
	...
	return (typeof activationFunction === 'string') ? activationFunction.replace(/^FANN_/, '') : activationFunction;
});
...
ANN.prototype.setWeightArray = blockOnAsync(wrapThrows(function(connections, size) {
