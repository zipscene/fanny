...
// TODO: http://libfann.github.io/fann/docs/files/fann_cpp-h.html#neural_net.get_learning_rate recommend this value be between 0.0 and 1.0 but doesn't enforce that do we want to warn when it exceeds those bounds.
	...
	cascadeMaxOutEpochs: {
		setValue: function(value) {
			...
			this._fanny.setCascadMaxOutEpochs(value);
		},
		getValue: function() {
	...
	cascadeActivationFunctions: {
		setValue: function(value) {
			if ((typeof value !== 'string')) throw new XError(XError.INVALID_ARGUMENT, 'Invalid cascadeActivationFunctions type');
			var cascadeActivationFunctions = value.includes('FANN_') ? value : 'FANN_' + value;
			this._fanny.setCascadeActivationFunctions(cascadeActivationFunctions);
		},
		getValue: function() {
